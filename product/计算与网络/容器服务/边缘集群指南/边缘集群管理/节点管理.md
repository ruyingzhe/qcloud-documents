...
4. 在“节点列表”页面中，单击【脚本添加节点】。
5. 在弹出的“添加边缘节点”窗口中，按照以下步骤进行配置，得到节点侧初始化脚本。
...
>- 可以检查日志文件确认安装过程：/tmp/tke-edge-install.log
8. 确认命令执行成功后，前往“节点列表”页面并刷新，即可查看已新增的节点。如下图所示：
